...
public List<Question> list = new ArrayList<Question>();
	...
	//question 1
	{
		...
		Witness witness1 = new Witness("John", "Holmes", "I saw the murder", "Testifying for the prosecution", 1, 3); 
		...
		Transcript transcript1 = new Transcript(previousQuestion1, "What did you see?", "I heard timmy saying he saw the murder", 4, 5, 1); 
	...
	//question 2
	{
		...
		Witness witness2 = new Witness("John", "Holmes", "I saw the murder", "Testifying for the prosecution", 1, 3); 
			
			List<String> previousQuestion2 = new ArrayList<String>();
			previousQuestion2.add("Prosecution Question: Where you there that night? Answer: I was outside the bar");
		Transcript transcript2 = new Transcript(previousQuestion2, "What did you see?", "I heard timmy saying he saw the murder", 4, 5, 1); 
		
		List<Objection> correctObjections2 = new ArrayList<Objection>();
				ObjectionType hearsay = new ObjectionType("Hearsay", "Blah Blah...rule 802", 802); 
				ObjectionType ultimate = new ObjectionType("Ultimate Issue", "Blah Blah...rule 704(b)", 704); 
			Objection obj3 = new Objection(hearsay, "This response is hearsay, it is an out of court statement being offered for the truth of the matter asserted", "answer", 1, 5, 802); 
			Objection obj4 = new Objection(ultimate, "This response is going to the ultimate issue (really only experts are subject)", "answer", 2, 5, 704);
